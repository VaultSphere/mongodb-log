...
- Modify：`CLAUDE.md`
- Modify：`ROADMAP.md`
- Create：`src/test/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcFixtureBuilder.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcFileReader.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcDocument.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcFormatException.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcFileReaderTest.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcSchema.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcBaselineFlattener.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcVarIntReader.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcBlockScanner.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/parser/ftdc/FtdcBlockScannerTest.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/storage/ftdc/FtdcIndexWriter.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/storage/ftdc/FtdcIndexReader.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/storage/ftdc/FtdcCatalog.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/storage/ftdc/FtdcBlockIndex.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/storage/ftdc/FtdcIndexRepositoryTest.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/task/ftdc/FtdcTask.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/task/ftdc/FtdcTaskStatus.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/task/ftdc/FtdcTaskInputFile.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/task/ftdc/FtdcOperationGate.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/task/ftdc/FtdcTaskService.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/task/ftdc/FtdcTaskRunner.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/storage/ftdc/FtdcTaskRepository.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/storage/ftdc/FileFtdcTaskRepository.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/task/ftdc/FtdcTaskRunnerTest.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/storage/ftdc/FileFtdcTaskRepositoryTest.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcMetricDecoder.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcSeriesQuery.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcSeriesResult.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcSeriesService.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcSeriesServiceTest.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcMetricPage.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcMetricExportService.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcMetricPagingTest.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcMetricExportServiceTest.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/web/FtdcTaskController.java`
- Test：`src/test/java/com/vaultsphere/mongodblog/web/FtdcTaskControllerIntegrationTest.java`
...
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcMetricGroups.java`
- Create：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcGroupSeriesResult.java`
- Modify：`src/main/java/com/vaultsphere/mongodblog/storage/ftdc/FtdcIndexReader.java`
- Modify：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcMetricDecoder.java`
- Modify：`src/main/java/com/vaultsphere/mongodblog/analysis/ftdc/FtdcSeriesService.java`
- Modify：`src/main/java/com/vaultsphere/mongodblog/web/FtdcTaskController.java`
- Create：`web/src/components/ftdc/FtdcMetricGroupChart.vue`
- Modify：`web/src/components/ftdc/FtdcWorkspace.vue`

- [x] 先写参考路径归组、稳定 groupId、分组序列及 API 测试。
